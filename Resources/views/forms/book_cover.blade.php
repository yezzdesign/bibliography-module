<x-acp::forms.create
    :title="__('bibliography::forms.book_cover.title')"
    :description="__('bibliography::forms.book_cover.description')">

    <div class="md:grid md:grid-cols-3 md:gap-6">

        {{-- 1. Col with input --}}
        <div class="md:col-span-2">
            <div class="mt-1 flex justify-center px-6 pt-3 pb-3 border-2 @if($errors->has('book_cover')) border-main_brand_error @else border-main_brand/50 @endif border-dashed rounded-sm">
                <div class="space-y-1 text-center">
                    ...
                    <div class="flex text-sm text-main_font">
                        <label for="file-upload"
                            ...
                            <input id="file-upload" name="book_cover" type="file" class="sr-only">
                        </label>
        ...
        <div class="md:col-span-1">
            <div class="flex">
                @error('book_cover')<p class="block w-full sm:text-sm text-main_brand_error">{{$message}} </p> @enderror
            </div>
        </div>
    </div>
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        ...
        <div class="md:col-span-2">
            ...
            @if(isset($book->book_cover)) {{ config('app.url') . '/storage/' . $book->book_cover }}
