<x-acp::forms.create
    :title="__('bibliography::forms.book_status.title')"
    :description="__('bibliography::forms.book_status.description')">
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="flex flex-col">
                        <label for="check" class="inline-flex items-center">
                            <input
                                ...
                                id="check"
                                @checked( old('book_status') ?? $book->book_status ?? false )
                            >
        ...
        <div class="md:col-span-1">
            <div class="flex">
                @error('book_status')<p class="block w-full sm:text-sm text-main_brand_error">{{$message}} </p> @enderror
            </div>
